...
from sheepdog.github.provisioning import ensure_pr_checkout, resolve_pr_workdir
...
def test_pr_head_exact_checkout(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("SHEEPDOG_REPO_REMOTE_ACME__BACKEND", remote)
...
def test_approximate_checkout_disclosed_in_status():
    from sheepdog.pipeline import AnalysisResult, DriftFinding, TriggerContext, surface_result
