...
class AgentSession:
    ...
    def format_ascii_view(self) -> str:
        ...
        lines = [
            "================================================================",
            f"              KOYOTE AGENT SESSION #{self.session_id}          ",
            "================================================================",
...
class SessionManager:
    """Manages persistence and operations for AgentSessions under .koyote/sessions/."""

    def __init__(self, workdir: str = ".") -> None:
        self.workdir = os.path.abspath(workdir)
        self.sessions_dir = os.path.join(self.workdir, ".koyote", "sessions")
