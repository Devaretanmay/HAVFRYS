...
"""
Koyote MCP (Model Context Protocol) Server.

Exposes Koyote's autonomous software maintenance engine to AI assistants
...
TOOLS: list[dict[str, Any]] = [
    ...
    {
        "name": "koyote_analyze_dependency",
...
def handle_tool_call(name: str, arguments: dict[str, Any]) -> dict[str, Any]:
    ...
    elif name == "koyote_analyze_dependency":
    ...
    elif name == "koyote_repair_and_verify":
            ...
            "content": [
                {
                    "type": "text",
                    "text": (
                        f"Koyote Repair Status: {'SUCCESS [GREEN]' if report.success else 'FAILED'}\n"
    ...
    elif name == "koyote_explain_drift":
