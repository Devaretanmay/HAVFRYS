...
def git_commit_and_push(
    ...
    subprocess.run(["git", "config", "user.name", "Koyote Bot"], cwd=repo_dir, capture_output=True)
    subprocess.run(["git", "config", "user.email", "bot@koyote.dev"], cwd=repo_dir, capture_output=True)
