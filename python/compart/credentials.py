...
"""Secure BYOK AI provider credential management for Compart."""
...
def get_active_provider_summary() -> Dict[str, Any]:
    ...
    if os.environ.get("COMPART_LLM_KEY"):
        return {"configured": True, "provider": "custom", "source": "env:COMPART_LLM_KEY"}
