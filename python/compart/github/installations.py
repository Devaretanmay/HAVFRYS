...
No database: one file per installation under ~/.compart/installations/.
...
def store_dir() -> str:
    base = os.environ.get("COMPART_INSTALLATIONS_DIR",
                           os.path.join(os.path.expanduser("~/.compart"), "installations"))
