...
known failures; Sheepdog applies the resulting SEARCH/REPLACE edits, verifies
...
from sheepdog.autopatch import ScanConfig, scan_callsites
from sheepdog.knowledge import lookup as kb_lookup
from sheepdog.llm import LLMClient, resolve_llm_config
from sheepdog.patch_writer import PatchResult
from sheepdog.test_runner import _detect_test_command
