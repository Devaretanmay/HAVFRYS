...
from sheepdog.credentials import load_credentials
...
def resolve_llm_config(
    ...
    key = api_key or os.environ.get("SHEEPDOG_LLM_KEY")
    url = base_url or os.environ.get("OPENAI_BASE_URL")

    anthropic_key = os.environ.get("ANTHROPIC_API_KEY")
    openai_key = os.environ.get("OPENAI_API_KEY")

    # If no explicit args or env vars, check ~/.sheepdog/credentials.json
