...
class IntegrationEngine:
    ...
    def __init__(self, workdir: str = ".") -> None:
        ...
        self.integration_dir = os.path.join(self.workdir, ".sheepdog", "integration")
    ...
    def preview(self) -> str:
        ...
        if not cand:
            return "No active integration candidate. Run 'sheepdog integrate <lane1> <lane2>' first."

        lines = [
            "================================================================",
            f"            SHEEPDOG INTEGRATION CANDIDATE #{cand.candidate_id}   ",
            "================================================================",
