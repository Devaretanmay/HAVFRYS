...
Implements the GitButler-equivalent Virtual Agent Lane abstraction for Sheepdog.
...
class LaneManager:
    """Manages Virtual Agent Lanes under .sheepdog/lanes/."""

    def __init__(self, workdir: str = ".") -> None:
        self.workdir = os.path.abspath(workdir)
        self.lanes_dir = os.path.join(self.workdir, ".sheepdog", "lanes")
