...
Every workload Sheepdog governs - interactive agents, workflows, scripts,
...
_logger = logging.getLogger("sheepdog.engine.execution")
...
class ExecutionManager:
    """Persists and retrieves Execution domain objects under .sheepdog/executions/."""

    def __init__(self, workdir: str = ".") -> None:
        self.workdir = os.path.abspath(workdir)
        self.executions_dir = os.path.join(self.workdir, ".sheepdog", "executions")
