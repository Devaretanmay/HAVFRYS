...
Provides a :class:`SheepdogCodeInterpreterTool` that plugs into CrewAI agents
in place of the Docker-based ``CodeInterpreterTool``. The agent-supplied
Python code runs inside a kernel-enforced
:class:`sheepdog.AgentSheepdog` compartment: deny-by-default filesystem,
...
class SheepdogCodeInterpreterTool(_CrewaiBaseTool):  # type: ignore[misc]
    """CrewAI-compatible tool that runs Python inside a Sheepdog sandbox.
    ...
    name: str = "sheepdog_code_interpreter"
    description: str = (
...
class CrewAICodeExecutor:
    ...
    Wraps :class:`~sheepdog.hooks.base.SandboxRunner` behind a small
    ...
    def execute(self, code: str, language: str = "python") -> Dict[str, Any]:
        ...
        -------
        dict[str, Any]
            :meth:`~sheepdog.hooks.base.ExecutionResult.as_dict` payload.
        """
