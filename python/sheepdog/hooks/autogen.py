...
Implements a :class:`SheepdogCodeExecutor` that satisfies AutoGen's
...
kernel-enforced :class:`sheepdog.AgentSheepdog` compartment. This replaces
AutoGen's default ``LocalCommandLineCodeExecutor`` / Docker executor with
Sheepdog isolation: deny-by-default filesystem, blocked network, and BLAKE3
...
class SheepdogCodeExecutor:
    """Execute AutoGen code blocks inside a Sheepdog compartment.
