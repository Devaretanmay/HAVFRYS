...
"""
Sheepdog MCP (Model Context Protocol) Server.

Exposes Sheepdog's autonomous software maintenance engine to AI assistants
...
from sheepdog.audit import render_audit_cli
from sheepdog.graph import audit_dependency_graph, build_dependency_graph
from sheepdog.maintenance import detect_drift, run_maintenance_cycle
...
TOOLS: List[Dict[str, Any]] = [
    ...
    {
        "name": "sheepdog_analyze_dependency",
    ...
    {
        "name": "sheepdog_repair_and_verify",
...
def handle_tool_call(name: str, arguments: Dict[str, Any]) -> Dict[str, Any]:
    ...
    elif name == "sheepdog_analyze_dependency":
    ...
    elif name == "sheepdog_repair_and_verify":
            ...
            "content": [
                {
                    "type": "text",
                    "text": (
                        f"Sheepdog Repair Status: {'SUCCESS [GREEN]' if report.success else 'FAILED'}\n"
    ...
    elif name == "sheepdog_explain_drift":
