...
No database: one file per installation under ~/.sheepdog/installations/.
...
def store_dir() -> str:
    base = os.environ.get("SHEEPDOG_INSTALLATIONS_DIR",
                           os.path.join(os.path.expanduser("~/.sheepdog"), "installations"))
