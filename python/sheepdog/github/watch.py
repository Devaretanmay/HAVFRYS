...
from sheepdog.github.installations import REPO_INDEXED, REPO_READY, save_installation, store_dir
from sheepdog.github.provisioning import ensure_repo_checkout
from sheepdog.pipeline import MaintenancePipeline, TriggerContext

_logger = logging.getLogger("sheepdog.watch")
