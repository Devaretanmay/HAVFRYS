...
"""Persistent Repository Knowledge Base (.volf/knowledge/).
...
def _kb_dir(repo_dir: str) -> str:
    return os.path.join(os.path.abspath(repo_dir), ".volf", "knowledge")
...
def _rename_legacy_entry_path(repo_dir: str, provider: str, from_version: str, to_version: str) -> str:
    ...
    # keep reading across the Compart -> Sheepdog -> Volf renames.
