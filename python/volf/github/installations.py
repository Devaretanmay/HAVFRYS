...
No database: one file per installation under ~/.volf/installations/.
...
def store_dir() -> str:
    base = os.environ.get("VOLF_INSTALLATIONS_DIR",
                           os.path.join(os.path.expanduser("~/.volf"), "installations"))
