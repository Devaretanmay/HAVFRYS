"""GitHub API Client & Authentication for Volf App."""
...
class GitHubAppClient:
    ...
    def __init__(
        ...
        self.token = token or os.environ.get("GITHUB_TOKEN") or os.environ.get("VOLF_GITHUB_TOKEN") or _get_gh_cli_token()
        self.app_id = app_id or os.environ.get("VOLF_GITHUB_APP_ID")
        self.private_key = private_key or os.environ.get("VOLF_GITHUB_PRIVATE_KEY")
    ...
    def get_installation_access_token(self, installation_id: int) -> Optional[str]:
        ...
        req = urllib.request.Request(
            ...
            headers={
                ...
                "User-Agent": "Volf-Autonomous-Maintenance/1.0",
            },
            method="POST",
        )
        try:
    ...
    def set_commit_status(
        ...
        sha: str,
        state: str,
        context: str = "volf/verification",
        description: str = "Volf zero-blast-radius verified",
