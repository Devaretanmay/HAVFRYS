...
def git_commit_and_push(
    ...
    subprocess.run(["git", "config", "user.name", "Volf Bot"], cwd=repo_dir, capture_output=True)
    subprocess.run(["git", "config", "user.email", "bot@volf.dev"], cwd=repo_dir, capture_output=True)
