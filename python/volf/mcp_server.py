...
"""
Volf MCP (Model Context Protocol) Server.

Exposes Volf's autonomous software maintenance engine to AI assistants
...
from volf.audit import render_audit_cli
from volf.graph import audit_dependency_graph, build_dependency_graph
from volf.maintenance import detect_drift, run_maintenance_cycle
...
def handle_tool_call(name: str, arguments: Dict[str, Any]) -> Dict[str, Any]:
    ...
    elif name == "volf_analyze_dependency":
    ...
    elif name == "volf_repair_and_verify":
            ...
            "content": [
                {
                    "type": "text",
                    "text": (
                        f"Volf Repair Status: {'SUCCESS [GREEN]' if report.success else 'FAILED'}\n"
