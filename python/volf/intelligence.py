...
"""Volf Intelligence — invisible smart routing (blueprint box 5).
...
from volf.knowledge import _norm_version, direct_rewrites_for
from volf.providers.registry import find_migration_for, get_default_registry
