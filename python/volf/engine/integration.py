...
class IntegrationEngine:
    ...
    def __init__(self, workdir: str = ".") -> None:
        ...
        self.integration_dir = os.path.join(self.workdir, ".volf", "integration")
    ...
    def preview(self) -> str:
        ...
        if not cand:
            return "No active integration candidate. Run 'volf integrate <lane1> <lane2>' first."

        lines = [
            "================================================================",
            f"            VOLF INTEGRATION CANDIDATE #{cand.candidate_id}   ",
            "================================================================",
