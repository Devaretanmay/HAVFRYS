...
Every workload Volf governs - interactive agents, workflows, scripts,
...
_logger = logging.getLogger("volf.engine.execution")
...
class ExecutionManager:
    """Persists and retrieves Execution domain objects under .volf/executions/."""

    def __init__(self, workdir: str = ".") -> None:
        self.workdir = os.path.abspath(workdir)
        self.executions_dir = os.path.join(self.workdir, ".volf", "executions")
