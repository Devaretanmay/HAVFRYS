...
_logger = logging.getLogger("volf.session")
...
class AgentSession:
    ...
    def format_ascii_view(self) -> str:
        ...
        lines = [
            "================================================================",
            f"              VOLF AGENT SESSION #{self.session_id}          ",
            "================================================================",
...
class SessionManager:
    """Manages persistence and operations for AgentSessions under .volf/sessions/."""

    def __init__(self, workdir: str = ".") -> None:
        self.workdir = os.path.abspath(workdir)
        self.sessions_dir = os.path.join(self.workdir, ".volf", "sessions")
