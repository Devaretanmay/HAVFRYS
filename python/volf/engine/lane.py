...
Implements the GitButler-equivalent Virtual Agent Lane abstraction for Volf.
...
class LaneManager:
    """Manages Virtual Agent Lanes under .volf/lanes/."""

    def __init__(self, workdir: str = ".") -> None:
        self.workdir = os.path.abspath(workdir)
        self.lanes_dir = os.path.join(self.workdir, ".volf", "lanes")
