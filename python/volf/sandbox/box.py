...
inner compartments are registered explicitly. AgentVolf sets
...
_logger = logging.getLogger("volf.box")

try:
    from volf._core import sandbox_apply as _core_sandbox_apply, sandbox_check_supported as _core_sandbox_check_supported
...
class Box:
    ...
    def __init__(self, workdir: str = ".", config: Optional[BoxConfig] = None):
        ...
        self.box_dir = os.path.join(self.workdir, self.VOLF_DIR, "boxes", self.box_id)
