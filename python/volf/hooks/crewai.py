...
Provides a :class:`VolfCodeInterpreterTool` that plugs into CrewAI agents
in place of the Docker-based ``CodeInterpreterTool``. The agent-supplied
Python code runs inside a kernel-enforced
:class:`volf.AgentVolf` compartment: deny-by-default filesystem,
...
class VolfCodeInterpreterTool(_CrewaiBaseTool):  # type: ignore[misc]
    """CrewAI-compatible tool that runs Python inside a Volf sandbox.
    ...
    name: str = "volf_code_interpreter"
    description: str = (
...
class CrewAICodeExecutor:
    ...
    Wraps :class:`~volf.hooks.base.SandboxRunner` behind a small
    ...
    def execute(self, code: str, language: str = "python") -> Dict[str, Any]:
        ...
        -------
        dict[str, Any]
            :meth:`~volf.hooks.base.ExecutionResult.as_dict` payload.
        """
