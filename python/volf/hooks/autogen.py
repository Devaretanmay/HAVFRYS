...
Implements a :class:`VolfCodeExecutor` that satisfies AutoGen's
...
kernel-enforced :class:`volf.AgentVolf` compartment. This replaces
AutoGen's default ``LocalCommandLineCodeExecutor`` / Docker executor with
Volf isolation: deny-by-default filesystem, blocked network, and BLAKE3
...
class VolfCodeExecutor:
    """Execute AutoGen code blocks inside a Volf compartment.
